<template>
    <main class="app-content">
        <div class="app-title row">
                <div class="col-md-8">
                    <h3><i class="bi bi-collection"></i> Unidad: {{ titulo }}</h3> 
                     <h5><i class="fa fa-th-list"></i> Asignación y/o Transferencia</h5>
                </div>
                <div class="col-md-2">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="card shadow-lg border-secondary rounded-lg mt-12">
            <div class="card-header text-white bg-secondary">Responsable Actual</div>
            <div class="card-body">
              <div class="row">
                ...
                <label ><strong>Nombre:  </strong>{{ nomresp }}</label>
                <br>
                <label ><strong>Cargo:  </strong>{{ cargo }}</label>
                <br>
                <label ><strong>Oficina:  </strong>{{ oficina }}</label>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="card shadow-lg border-secondary rounded-lg mt-12">
            <div class="card-header text-white bg-secondary">Nuevo Responsable</div>
            <div class="card-body">
              <div class="row">
                <div class="mb-3 col-md-6">
                  <div class="mb-3 input-group" >
              ...
              <label> <strong>Nombre: </strong>{{ nomresp2 }}</label>
                <br>
                <label> <strong>Cargo: </strong>{{ cargo2 }}</label>
                <br>
                <label> <strong>Oficina: </strong>{{ oficina2 }}</label>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="card shadow-lg border-info rounded-lg mt-12">
              <div class="card-header justify-content-center bg-info"> Activos a Asignar</div>
              <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card shadow-lg border-info rounded-lg mt-12">
                <div class="card-header justify-content-center bg-info"> Activos Nuevo Responsable</div>
                <div class="card-body">
                    <div class="row">
                        <div class="table-responsive table-fixed">
                            <table class="table table-bordered table-striped table-hover table-sm">
      ...
      <div class="modal fade" tabindex="-1" :class="{'mostrar' : modal2}" role="dialog" aria-labelledby="myModalLabel" style="display: none;">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Buscar Responsable</h4>
  ...
  methods: {
    ...
    registrarAsignacion1(){
        ...
        axios.put('/actual/actualizarasingacion',{
          ...
          window.open('/actual/repAsignaciones?codofic=' + this.cod_ofi + '&codresp='+ this.cod_resp + '&unidad='+ this.idunidad +  '','_blank');
          this.cancelarAsignacion1();
        }).catch((error)=>{
            console.log(error);
        });
    ...
    acta_devolucion(){
        let me = this;
        window.open('/devoluciones/actaDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&unidad=' + me.idunidad + '&id_dev=' + me.id_dev +'','_blank');
    },
    acta_asignacion(){
        let me = this;
        window.open('/asignaciones/actaAsignaciones?codofic=' + me.cod_ofi2 + '&codresp='+ me.cod_resp2 +  '&unidad=' + me.idunidad + '&id_asig=' + me.id_asig);
    ...
    finalizar(){
     ...
     ayuda() {
        ...
        html: `
            ...
            <p>📦 <strong>Opciones de transferencia</strong><br>
            Puedes realizar la transferencia de activos de forma <strong>masiva</strong> o <strong>item por item</strong>.</p>

            <p>👥 <strong>Selecciona responsables</strong><br>
            En ambos casos, debes seleccionar un <strong>responsable de origen</strong> y <strong> responsable de destino</strong>.</p>

            <ul>
                <li>🔍 Búscalos por <strong>Carnet de Identidad</strong></li>
                <li>📋 O usa el botón <strong>"Buscar"</strong> para ver la lista completa</li>
            </ul>

            <p>📑 <strong>Información automática</strong><br>
            Al seleccionar un responsable, el sistema mostrará sus <strong>activos asignados</strong> para facilitar la transferencia.</p>
            </div>
        `,
        icon: 'info',
