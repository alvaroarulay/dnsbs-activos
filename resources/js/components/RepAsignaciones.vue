      ...
      <div class="app-title row">
             <div class="col-md-8">
                <h1><i class="bi bi-collection"></i> Unidad: {{ titulo }}</h1>
                 <h5><i class="fa fa-th-list"></i> Reporte de Asignaciones</h5>
             </div>
             <div class="col-md-4">
        ...
        <div class="col-md-8 col-12">
            <div class="card shadow-lg border-secondary rounded-lg mb-3">
              ...
              <div class="card-body">
                ...
                <label for="nombre"><strong>Nombre: </strong></label> {{ nomresp }}<br>
                <label for="cargo"><strong>Cargo: </strong></label> {{ cargo }}<br>
                <label for="oficina"><strong>Oficina: </strong></label> {{ oficina }}<br>
              </div>
            </div>
            <div class="card shadow-lg border-secondary rounded-lg mb-3">
              <div class="card-header bg-secondary text-white"> <strong>Activos Asignados</strong> </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
...
export default {
  ...
  methods: {
    ...
    agregarDetalleModal(data){
        ...
        this.listarAsignaciones(data.codresp,data.codofic);
        this.buscarActivo();
        this.listarGrupoContable(data.codresp,data.codofic);
    },
    listarAsignaciones(codresp,codofic){
        let me=this;
        var url= '/asignaciones?codresp='+ codresp + '&codofic=' + codofic + '&unidad=' + me.idunidad;
    ...
    registrarAsignacion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        me.pdf ='/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&codcont='+ me.codcont + '&unidad='+me.idunidad + '&fecha=' + me.fecha;
        me.modalpdf = 1;
      }
      else{
        let me = this;
        me.pdf ='/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&data='+ me.checkContables + '&unidad='+me.idunidad + '&fecha=' + me.fecha;
        me.modalpdf = 1;
      }
    },
    cerrarModalpdf(){
    ...
    registrarDevolucion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        me.pdf='/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&codcont='+ me.codcont  + '&unidad=' + me.idunidad + '&fecha=' + me.fecha;
        me.modalpdf = 1;
      }
      else{
        let me = this;
        me.pdf='/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&data='+ me.checkContables  + '&unidad=' + me.idunidad;
        me.modalpdf = 1;
      }
    },
