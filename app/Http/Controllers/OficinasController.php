...
class OficinasController extends Controller
{
    public function index(Request $request)
    {
        ...
        $edif = $request->edif;
        $query  = Oficinas::select('oficina.id','oficina.codofic','oficina.nomofic','oficina.api_estado','oficina.observ')->where('oficina.idestablecimiento','=',$edif);
    ...
    public function buscarOficina(Request $request){
        ...
        $oficina = Oficinas::where('idestablecimiento','=',$edif)->where('codofic','=', $filtro)->first();
